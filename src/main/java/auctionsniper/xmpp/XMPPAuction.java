...
public class XMPPAuction implements Auction {
    ...
    public XMPPAuction(XMPPConnection connection, String itemId)
        ...
        chat = manager.chatWith(auctionJid(itemId, connection
        ...
        manager.addIncomingListener(new AuctionMessageTranslator(connection
                .getUser().toString(), // `XMPPConnection.connection` は
                                       // `EntityFullJid` を返す。
    ...
    private EntityBareJid auctionJid(String itemId, String xmppDomainName)
            throws XmppStringprepException {
