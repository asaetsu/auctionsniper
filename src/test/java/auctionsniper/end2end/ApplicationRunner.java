...
public class ApplicationRunner {
    ...
    public void startBiddingIn(final FakeAuctionServer... auctions) {
        ...
        for (FakeAuctionServer auction : auctions) {
            ...
            driver.showsSniperStatus(auction.getItemId(), 0, 0,
                    SnipersTableModel.textFor(JOINING));
        }
    }
    ...
    public void hasShownSniperIsBidding(FakeAuctionServer auction,
            int lastPlace, int lastBid) {
        driver.showsSniperStatus(auction.getItemId(), lastPlace, lastBid,
                SnipersTableModel.textFor(BIDDING));
    }
    ...
    public void hasShownSniperHasLostAuction(FakeAuctionServer auction,
        ...
        driver.showsSniperStatus(auction.getItemId(), lastPrice, lastBid,
                SnipersTableModel.textFor(LOST));
    }
    ...
    public void hasShownSniperIsWinning(FakeAuctionServer auction,
        ...
        driver.showsSniperStatus(auction.getItemId(), winningBid, winningBid,
                SnipersTableModel.textFor(WINNING));
    }

    public void hasShownSniperHasWonAuction(FakeAuctionServer auction,
            int lastPrice) {
        driver.showsSniperStatus(auction.getItemId(), lastPrice, lastPrice,
                SnipersTableModel.textFor(WON));
    }
