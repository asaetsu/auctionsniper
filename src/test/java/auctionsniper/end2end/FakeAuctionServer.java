...
public class FakeAuctionServer {
    ...
    public FakeAuctionServer(String itemId) throws XmppStringprepException,
        ...
        XMPPTCPConnectionConfiguration config = XMPPTCPConnectionConfiguration
                ...
                .setUsernameAndPassword(
                        ...
                        AUCTION_PASSWORD).setResource(AUCTION_RESOURCE)
                .setXmppDomain(XMPP_DOMAIN_NAME)
                .setHostAddress(InetAddress.getByName(XMPP_HOST_NAME))
                .setPort(XMPP_PORT).setDebuggerEnabled(true).build();
    ...
    public void startSellingItem() throws InterruptedException, XMPPException,
    ...
    private void receivesAMessageMatching(String sniperId,
        ...
        // Name`(itemId)を付加して比較する。
        assertThat(partner.jid.asEntityBareJidString() + "/" + itemId,
                is(sniperId));
    }
