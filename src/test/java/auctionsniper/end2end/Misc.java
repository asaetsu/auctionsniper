...
public class Misc {
    ...
    public void xxx() throws Exception {
        ...
        try {
            XMPPTCPConnectionConfiguration config1 = XMPPTCPConnectionConfiguration
                    .builder()
                    .setSecurityMode(
                            ConnectionConfiguration.SecurityMode.disabled)
                    .setUsernameAndPassword("auction-item-54321", "auction")
                    .setResource("Auction").setXmppDomain("localhost")
                    .setHostAddress(InetAddress.getLocalHost()).setPort(5222)
            ...
            chatManager1.addIncomingListener((EntityBareJid entityBareJid,
                    Message message, Chat chat) -> {
                chats.add(chat);
                System.out.println(message.getBody());
            });

            XMPPTCPConnectionConfiguration config2 = XMPPTCPConnectionConfiguration
                    .builder()
                    .setSecurityMode(
                            ConnectionConfiguration.SecurityMode.disabled)
                    .setUsernameAndPassword("sniper", "sniper")
                    .setResource("Sniper").setXmppDomain("localhost")
                    .setHostAddress(InetAddress.getLocalHost()).setPort(5222)
                    .setDebuggerEnabled(true).build();
            ...
            EntityBareJid jid = JidCreate
                    .entityBareFrom("auction-item-54321@localhost");
